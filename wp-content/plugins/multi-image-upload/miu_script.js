...
function addRow(image_url){
    ...
    itemsCount+=1;
    var emptyRowTemplate = '<div id=row-'+itemsCount+'><img src=\''+image_url+'\' style=\'width:10%\'  /> <input style=\'width:70%\' id=img-'+itemsCount+' type=\'hidden\' name=\'miu_images['+itemsCount+']\' value=\''+image_url+'\' />'
